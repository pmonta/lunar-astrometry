...
solve-field --verify init.wcs --no-plots --overwrite --x-column XWIN_IMAGE --y-column YWIN_IMAGE --sort-column FLUX_AUTO --width 3283 --height 3283 --scale-low 17 --scale-high 22 --scale-units arcsecperpix --no-tweak --crpix-center predistort.xylist

# extract the WCS header

fitshdr predistort.xylist.wcs >temp3.ahead
